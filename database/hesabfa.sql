...
INSERT INTO `products` (`id`, `name`, `price`, `description`, `main_unit`, `sub_unit`, `conversion_factor`, `category`) VALUES
(1, '', 0.00, '', 'number', '', 1.0000, NULL),
(2, '', 0.00, '', 'number', '', 1.0000, NULL),
(3, '', 0.00, '', 'number', '', 1.0000, NULL),
(4, '', 0.00, 'سیبس', 'number', '', 1.0000, NULL),
(5, '', 0.00, '', 'number', '', 1.0000, '6');
